...
interface KnowMeWellAiAnalysisResultModalProps {
  visible: boolean;
  onClose: () => void;
  onRetry?: () => void;
  isLoading: boolean;
...
const KnowMeWellAiAnalysisResultModal: React.FC<
  KnowMeWellAiAnalysisResultModalProps
> = ({ visible, onClose, onRetry, isLoading, error, result, player1Name, player2Name }) => {
        ...
        {isLoading ? (
          ...
          >
            <SectionCard
              ...
              title={`${player1Name || "1. Oyuncu"}, ${player2Name || "2. Oyuncu"} hakkında neleri yanlış biliyor ve bu ilişkinizde nelere sebep olabilir?`}
              content={result.player1AboutPlayer2 || "-"}
              delay={100}
            />
            ...
            <SectionCard
              ...
              title={`${player2Name || "2. Oyuncu"}, ${player1Name || "1. Oyuncu"} hakkında neleri yanlış biliyor ve bu ilişkinizde nelere sebep olabilir?`}
              content={result.player2AboutPlayer1 || "-"}
              delay={300}
            />
          </ScrollView>
        ) : null}
...
export default KnowMeWellAiAnalysisResultModal;
